    ...
    "en": {
        ...
        "account_explorer": {
            ...
            "setup": {
                ...
                "alerts_title": "Alerts",
                "alerts_help": "Define filters that highlight accounts and related records when their conditions match.",
                "alerts_guide_link": "Open alert configuration guide",
                "alerts_add_button": "Add alert",
                "alerts_remove_button": "Remove",
                "alerts_empty": "No alerts configured yet.",
                "alerts_label": "Alert name",
                "alerts_label_placeholder": "Missing contact details",
                "alerts_message_label": "Explanation",
                "alerts_message_placeholder": "Explain why this alert triggers.",
                "alerts_object_label": "Target object",
                "alerts_expression_label": "Filter expression",
                "alerts_expression_placeholder": "record.Email == null",
                "alerts_field_helper_label": "Insert field",
                "alerts_field_helper_placeholder": "Select a field to insert",
                "alerts_enabled_label": "Enabled",
        ...
        "guide": {
            ...
            "sections": {
                ...
                "account_explorer_alerts": {
                    "title": "Account explorer alerts",
                    "description": "Configure alert filters to flag data quality issues directly in the explorer.",
                    "steps": [
                        "Open the <strong>Account Explorer</strong> and click <strong>Set up</strong>.",
                        "Use <strong>Add alert</strong> to create a rule, choose the object to evaluate, and write a JavaScript-style condition such as <code>helpers.isBlank(record.Email)</code>.",
                        "Click <strong>Insert field</strong> to add field names with autocomplete and describe the alert so the tooltip explains why it triggered.",
                        "Save the configuration and rerun the explorer; matching accounts and records will be highlighted in red.",
                    ],
                },
            },
            "tip": {
    ...
    "it": {
        ...
        "account_explorer": {
            ...
            "setup": {
                ...
                "alerts_title": "Avvisi",
                "alerts_help": "Definisci filtri che evidenziano gli account e i record collegati quando le condizioni sono soddisfatte.",
                "alerts_guide_link": "Apri guida alla configurazione degli avvisi",
                "alerts_add_button": "Aggiungi avviso",
                "alerts_remove_button": "Rimuovi",
                "alerts_empty": "Nessun avviso configurato.",
                "alerts_label": "Nome avviso",
                "alerts_label_placeholder": "Contatti senza telefono",
                "alerts_message_label": "Spiegazione",
                "alerts_message_placeholder": "Descrivi perché si attiva l'avviso.",
                "alerts_object_label": "Oggetto di destinazione",
                "alerts_expression_label": "Espressione filtro",
                "alerts_expression_placeholder": "helpers.isBlank(record.Email)",
                "alerts_field_helper_label": "Inserisci campo",
                "alerts_field_helper_placeholder": "Seleziona un campo da inserire",
                "alerts_enabled_label": "Attivo",
        ...
        "guide": {
            ...
            "sections": {
                ...
                "account_explorer_alerts": {
                    "title": "Avvisi dell'esploratore account",
                    "description": "Configura filtri di avviso per evidenziare le anomalie direttamente nell'esploratore.",
                    "steps": [
                        "Apri l'<strong>Esploratore account</strong> e fai clic su <strong>Configura</strong>.",
                        "Usa <strong>Aggiungi avviso</strong> per creare una regola, scegli l'oggetto da valutare e scrivi una condizione in stile JavaScript, ad esempio <code>helpers.isBlank(record.Email)</code>.",
                        "Fai clic su <strong>Inserisci campo</strong> per aggiungere rapidamente i nomi dei campi e compila la spiegazione che verrà mostrata nel tooltip.",
                        "Salva la configurazione e riesegui l'esploratore; gli account e i record corrispondenti saranno evidenziati in rosso.",
                    ],
                },
            },
            "tip": {
