    ...
    "en": {
        ...
        "account_explorer": {
            ...
            "results": {
                ...
                "alert_default_name": "Alert",
                "alert_record_summary": "{object}: {count} matching record(s)",
                "view": {
                    "label": "Results view",
                    "list": "List",
                    "tree": "Tree",
            ...
            "setup": {
                ...
                "alerts_title": "Alerts",
                "alerts_description": "Highlight accounts and related records when the expression evaluates to true.",
                "alerts_guide_link": "View alert guide",
                "alerts_add": "Add alert",
                "alerts_empty": "No alerts configured yet.",
                "alerts_name_label": "Alert name",
                "alerts_name_placeholder": "High-risk account",
                "alerts_remove": "Remove",
                "alerts_object_label": "Object to evaluate",
                "alerts_expression_label": "Filter expression",
                "alerts_expression_placeholder": "e.g. Contact.Phone == null && Contact.IsPrimary",
                "alerts_expression_help": "Use Salesforce field names and logical operators (==, !=, &&, ||, >, <, >=, <=).",
                "alerts_description_label": "Description (optional)",
                "alerts_description_placeholder": "Explain why the alert triggers",
                "alerts_field_help": "Select an org to load field suggestions.",
                "alerts_no_fields": "No fields available for this object.",
                "alerts_field_suggestions": "Click to insert a field",
                "alerts_loading_fields": "Loading fields…",
        ...
        "guide": {
            ...
            "sections": {
                ...
                "account_alerts": {
                    ...
                    "description": "Create alert rules to flag accounts and related records in the explorer.",
                    "steps": [
                        "Open the <strong>Account Explorer</strong> and click <strong>Set up</strong>.",
                        "Scroll to the <strong>Alerts</strong> section and select <strong>Add alert</strong>.",
                        "Choose the object to evaluate and enter a filter expression such as <code>Contact.Phone == null && Contact.IsPrimary == true</code>.",
                        "Use the autocomplete chips to insert field names and describe why the alert triggers so teammates understand the highlight.",
                        "Save the configuration, run the explorer, and hover any red badge to read the alert explanation.",
                    ],
                },
            },
            "tip": {
    ...
    "it": {
        ...
        "account_explorer": {
            ...
            "results": {
                ...
                "account_label": "Account",
                "alerts_heading": "Avvisi",
                "alert_default_name": "Avviso",
                "alert_record_summary": "{object}: {count} record corrispondenti",
                "view": {
            ...
            "setup": {
                ...
                "alerts_title": "Avvisi",
                "alerts_description": "Evidenzia account e record correlati quando l'espressione risulta vera.",
                "alerts_guide_link": "Apri guida agli avvisi",
                "alerts_add": "Aggiungi avviso",
                "alerts_empty": "Nessun avviso configurato.",
                "alerts_name_label": "Nome avviso",
                "alerts_name_placeholder": "Account ad alto rischio",
                "alerts_remove": "Rimuovi",
                "alerts_object_label": "Oggetto da valutare",
                "alerts_expression_label": "Espressione di filtro",
                "alerts_expression_placeholder": "es. Contact.Phone == null && Contact.IsPrimary",
                "alerts_expression_help": "Usa i nomi dei campi Salesforce e gli operatori logici (==, !=, &&, ||, >, <, >=, <=).",
                "alerts_description_label": "Descrizione (facoltativa)",
                "alerts_description_placeholder": "Spiega perché l'avviso si attiva",
                "alerts_field_help": "Seleziona un'organizzazione per caricare i suggerimenti.",
                "alerts_no_fields": "Nessun campo disponibile per questo oggetto.",
                "alerts_field_suggestions": "Clicca per inserire un campo",
                "alerts_loading_fields": "Caricamento campi…",
        ...
        "guide": {
            ...
            "sections": {
                ...
                "account_alerts": {
                    "title": "Avvisi account",
                    "description": "Configura regole di avviso per evidenziare account e record collegati nell'esploratore.",
                    "steps": [
                        "Apri l'<strong>Esploratore account</strong> e fai clic su <strong>Configura</strong>.",
                        "Scorri fino alla sezione <strong>Avvisi</strong> e seleziona <strong>Aggiungi avviso</strong>.",
                        "Scegli l'oggetto da valutare e inserisci un'espressione come <code>Contact.Phone == null && Contact.IsPrimary == true</code>.",
                        "Utilizza i suggerimenti per inserire i nomi campo e aggiungi una descrizione per spiegare perché l'avviso si attiva.",
                        "Salva la configurazione, esegui l'esplorazione e passa il mouse sui badge rossi per leggere la spiegazione.",
                    ],
                },
            },
            "tip": {
