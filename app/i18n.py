        ...
        "account_explorer": {
            ...
            "setup": {
                ...
                "alerts": {
                    ...
                    "mode_hint": "Use simple filters for quick checks or switch to advanced filters to compare related records with AND/OR logic.",
                    "field_placeholder": "Select a field",
                    "select_org_for_fields": "Select an org to load fields",
                    "advanced": {
                        "builder_intro": "Build complex rules with groups, scopes, and aggregate checks. Each dropdown shows how the selected records connect back to the Account.",
                        "empty": "Add a condition, scope, or aggregate to get started.",
                        "group_root_label": "Alert logic",
                        "group_label": "Condition group",
                        "remove_group": "Remove group",
                        "group_empty": "This group has no items yet.",
                        "add_scope": "Add related scope",
                        "add_condition": "Add condition",
                        "add_group": "Add subgroup",
                        "add_aggregate": "Add aggregate check",
                        "scope_label": "Scope",
                        "remove_scope": "Remove scope",
                        "scope_empty": "This scope has no conditions yet.",
                        "condition_label": "Condition",
                        "remove_condition": "Remove condition",
                        "aggregate_label": "Aggregate",
                        "remove_aggregate": "Remove aggregate",
                        "aggregate_description": "Aggregate checks group related records to look for duplicates or minimum counts.",
                        "aggregate_field": "Field to group by",
                        "aggregate_min_count": "Minimum records",
                        "aggregate_distinct_field": "Distinct by field (optional)",
                        "aggregate_filters": "Filter records before grouping",
                        "aggregate_add_filter": "Add aggregate filter",
                        "group_logic_all": "All conditions (AND)",
                        "group_logic_any": "Any condition (OR)",
                        "scope_match_any": "Any record matches",
                        "scope_match_all": "Every record matches",
                        "scope_match_not_all": "Not every record matches",
                        "scope_match_none": "No records match",
                        "aggregate_duplicates": "Duplicate values",
                        "scope_path": "Applies to: {path}",
                        "condition_path": "Field source: {path}",
                        "aggregate_path": "Analyzes: {path}",
                        "templates": {
                            "title": "Templates",
                            "description": "Start from a template and adjust the conditions to match your business rules.",
                            "use": "Use template",
                            "contact_roles": {
                                "label": "Duplicate contact roles",
                                "description": "Flag accounts when two different contacts share the same Account Contact Relation role.",
                            },
                            "contact_channels": {
                                "label": "Contact communication coverage",
                                "description": "Ensure every related Contact has at least a phone number or an email address.",
                            },
                        },
                    },
                },
            ...
            "account_explorer": {
                ...
                "run": {
                    ...
                    "alerts": {
                        ...
                        "mode": {
                            "label": "Modalità avviso",
                            "simple": "Filtri semplici",
                            "advanced": "Filtri avanzati",
                        },
                        "mode_hint": "Usa i filtri semplici per controlli rapidi oppure passa ai filtri avanzati per confrontare record correlati con logica AND/OR.",
                        "field_placeholder": "Seleziona un campo",
                        "select_org_for_fields": "Seleziona un'organizzazione per caricare i campi",
                        "advanced": {
                            "builder_intro": "Crea regole complesse con gruppi, scope e controlli aggregati. Ogni menu a discesa mostra come i record selezionati si collegano all'Account.",
                            "empty": "Aggiungi una condizione, uno scope o un aggregato per iniziare.",
                            "group_root_label": "Logica avviso",
                            "group_label": "Gruppo di condizioni",
                            "remove_group": "Rimuovi gruppo",
                            "group_empty": "Questo gruppo non contiene elementi.",
                            "add_scope": "Aggiungi scope correlato",
                            "add_condition": "Aggiungi condizione",
                            "add_group": "Aggiungi sottogruppo",
                            "add_aggregate": "Aggiungi controllo aggregato",
                            "scope_label": "Scope",
                            "remove_scope": "Rimuovi scope",
                            "scope_empty": "Questo scope non contiene condizioni.",
                            "condition_label": "Condizione",
                            "remove_condition": "Rimuovi condizione",
                            "aggregate_label": "Aggregato",
                            "remove_aggregate": "Rimuovi aggregato",
                            "aggregate_description": "I controlli aggregati raggruppano i record correlati per individuare duplicati o minimi.",
                            "aggregate_field": "Campo per il raggruppamento",
                            "aggregate_min_count": "Record minimi",
                            "aggregate_distinct_field": "Campo distintivo (opzionale)",
                            "aggregate_filters": "Filtra i record prima del raggruppamento",
                            "aggregate_add_filter": "Aggiungi filtro aggregato",
                            "group_logic_all": "Tutte le condizioni (AND)",
                            "group_logic_any": "Qualsiasi condizione (OR)",
                            "scope_match_any": "Almeno un record soddisfa",
                            "scope_match_all": "Tutti i record soddisfano",
                            "scope_match_not_all": "Non tutti i record soddisfano",
                            "scope_match_none": "Nessun record soddisfa",
                            "aggregate_duplicates": "Valori duplicati",
                            "scope_path": "Si applica a: {path}",
                            "condition_path": "Campo da: {path}",
                            "aggregate_path": "Analizza: {path}",
                            "templates": {
                                "title": "Template",
                                "description": "Parti da un template e adatta le condizioni alle tue esigenze.",
                                "use": "Usa template",
                                "contact_roles": {
                                    "label": "Ruoli contatto duplicati",
                                    "description": "Evidenzia gli account quando due contatti diversi condividono lo stesso ruolo in Account Contact Relation.",
                                },
                                "contact_channels": {
                                    "label": "Copertura contatti",
                                    "description": "Verifica che ogni Contatto collegato abbia almeno un numero di telefono o un indirizzo email.",
                                },
                            },
                        },
                    },
