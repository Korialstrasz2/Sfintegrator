        ...
        "account_explorer": {
            ...
            "setup": {
                ...
                "alerts": {
                    ...
                    "mode_label": "Alert type",
                    "mode_basic": "Basic filters",
                    "mode_advanced": "Advanced logic",
                    "operators": {
                        "equals": "equals",
                    ...
                    "advanced": {
                        "entities": {
                            "title": "Objects and nicknames",
                            "help": "Select the objects the alert can compare. Nicknames make it easy to reference them in conditions.",
                            "alias": "Nickname",
                            "object": "Object",
                            "distinct": "Must be different from",
                            "distinct_help": "Keep the alert from matching the same record twice.",
                            "connections": {
                                "label": "Connections",
                                "missing": "Select an object to see how it's connected.",
                                "account": "Uses the Account currently being evaluated.",
                                "none": "Matches records related to the account using this object's default relationship.",
                                "to_account": "Linked to Account via {field}",
                                "to_object": "Linked to {target} via {field}",
                                "generic": "Linked via {field}",
                            },
                        ...
                        "conditions": {
                            "title": "Conditions",
                            "help": "Combine AND/OR groups and compare fields across your selected objects.",
                            "group_operator": "Group operator",
                            "group_operator_and": "All conditions (AND)",
                            "group_operator_or": "Any condition (OR)",
                            "add_condition": "Add condition",
                            "add_group": "Add group",
                            "remove_condition": "Remove condition",
                            "remove_group": "Remove group",
                            "entity": "Object nickname",
                            "entity_placeholder": "Select a nickname",
                            "compare_type": "Compare to",
                            "compare_value": "Fixed value",
                            "compare_entity": "Other object field",
                            "target_entity": "Compare with",
                            "target_field": "Field to compare",
                        },
                    },
                },
        ...
        "account_explorer": {
            ...
            "run": {
                ...
                "alerts": {
                    ...
                    "mode_label": "Tipo di avviso",
                    "mode_basic": "Filtri semplici",
                    "mode_advanced": "Logica avanzata",
                    "operators": {
                        "equals": "uguale a",
                    ...
                    "advanced": {
                        "entities": {
                            "title": "Oggetti e alias",
                            "help": "Seleziona gli oggetti che l'avviso può confrontare e assegna un alias da usare nelle condizioni.",
                            "alias": "Alias",
                            "object": "Oggetto",
                            "distinct": "Deve essere diverso da",
                            "distinct_help": "Evita che l'avviso utilizzi lo stesso record due volte.",
                            "connections": {
                                "label": "Collegamenti",
                                "missing": "Seleziona un oggetto per vedere come è collegato.",
                                "account": "Utilizza l'Account attualmente in valutazione.",
                                "none": "Abbina i record collegati all'account usando la relazione predefinita dell'oggetto.",
                                "to_account": "Collegato all'Account tramite {field}",
                                "to_object": "Collegato a {target} tramite {field}",
                                "generic": "Collegato tramite {field}",
                            },
                            "remove": "Rimuovi oggetto",
                            "add": "Aggiungi oggetto",
                            "unnamed": "Oggetto senza nome",
                        },
                        "conditions": {
                            "title": "Condizioni",
                            "help": "Combina gruppi AND/OR e confronta i campi tra gli oggetti selezionati.",
                            "group_operator": "Operatore del gruppo",
                            "group_operator_and": "Tutte le condizioni (AND)",
                            "group_operator_or": "Almeno una condizione (OR)",
                            "add_condition": "Aggiungi condizione",
                            "add_group": "Aggiungi gruppo",
                            "remove_condition": "Rimuovi condizione",
                            "remove_group": "Rimuovi gruppo",
                            "entity": "Alias oggetto",
                            "entity_placeholder": "Seleziona un alias",
                            "compare_type": "Confronta con",
                            "compare_value": "Valore fisso",
                            "compare_entity": "Campo di un altro oggetto",
                            "target_entity": "Confronta con",
                            "target_field": "Campo da confrontare",
                        },
                    },
                },
