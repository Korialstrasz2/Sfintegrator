    ...
    "en": {
        ...
        "index": {
            ...
            "query": {
                ...
                "composer": {
                    ...
                    "subtitle": "Build complex SOQL statements with a guided wizard.",
                    "preview_title": "Query preview",
                    "preview_hint": "Updates automatically",
                    "preview_empty": "Select an object and fields to see the query.",
                    "common": {
                    ...
                    "steps": {
                        "templates": {
                            ...
                            "description": "Pick a template to prefill the wizard or start from scratch.",
                            "aria_label": "Available query templates",
                            "options": {
                                "custom": {
                                    "title": "Blank query",
                                    "description": "Start without presets and design the query manually.",
                                },
                                "basic": {
                                    "title": "Essential fields",
                                    "description": "Select identifiers and audit fields for quick exports.",
                                },
                                "recent": {
                                    "title": "Recently modified",
                                    "description": "Focus on recently changed records ordered by LastModifiedDate.",
                                },
                                "child_summary": {
                                    "title": "With child records",
                                    "description": "Start with a subquery that retrieves related child records.",
                                },
                            },
                        },
                        "object": {
                            "label": "Objects",
                            "title": "Pick the main object",
                            "description": "Choose the root object and optionally configure child relationships.",
                            "child_title": "Child relationships (subqueries)",
                            "add_child": "Add child relationship",
                            "child_empty": "No child relationships added yet.",
                            "labels": {
                                "object": "Base object",
                                "alias": "Alias (optional)",
                                "relationship": "Relationship API name",
                                "fields": "Child fields",
                                "where": "Child filter",
                            },
                            "placeholders": {
                                "object": "e.g. Account",
                                "alias": "e.g. ParentAccount",
                                "relationship": "e.g. Contacts",
                        ...
                        "fields": {
                            ...
                            "description": "Search, select, and prioritise the fields to include in the SELECT clause.",
                            "labels": {
                                "search": "Search fields",
                                "custom_field": "Add related or formula field",
                            },
                            "placeholders": {
                                "search": "Filter fields by name",
                                "custom_field": "e.g. Owner.Name or FORMAT(CreatedDate)",
                            },
                            "add_custom": "Add field",
                            "selected_title": "Selected fields",
                            "selected_empty": "No fields selected yet.",
                            "empty": "Select an object to load its fields.",
                        },
                        "filters": {
                            "label": "Filters",
                            "title": "Refine the results",
                            "description": "Add WHERE clauses, ordering, and limits to complete the query.",
                            "conditions_title": "Conditions",
                            "add_condition": "Add condition",
                            "conditions_empty": "No conditions defined.",
                            "order_title": "Ordering & limit",
                            "add_order": "Add order field",
                            "order_empty": "No ORDER BY fields added yet.",
                            "labels": {
                                "field": "Field",
                                "operator": "Operator",
                                "value": "Value",
                            ...
                            "placeholders": {
                                ...
                                "operator": "Choose",
                                "value": "Value or comma separated list",
                                "limit": "100",
                            },
                        },
                    },
        ...
        "frontend": {
            "toast": {
                ...
                "composer_requires_org": "Select an org before composing a query",
                "composer_select_object": "Choose an object to continue",
                "composer_select_field": "Choose at least one field",
                "composer_child_invalid": "Add a relationship name and at least one field",
                "composer_condition_invalid": "Complete the condition before adding it",
                "composer_order_invalid": "Select a field to order by",
    ...
    "it": {
        ...
        "index": {
            ...
            "query": {
                ...
                "composer": {
                    ...
                    "title": "Compositore di query",
                    "subtitle": "Crea istruzioni SOQL complesse con una procedura guidata.",
                    "preview_title": "Anteprima query",
                    "preview_hint": "Aggiornamento automatico",
                    "preview_empty": "Seleziona un oggetto e dei campi per vedere la query.",
                    "common": {"remove_button": "Rimuovi"},
                    "actions": {
                        "cancel": "Annulla",
                        "back": "Indietro",
                        "next": "Avanti",
                        "insert": "Inserisci query",
                    },
                    "steps": {
                        "templates": {
                            "label": "Modello",
                            "title": "Scegli un punto di partenza",
                            "description": "Seleziona un modello per precompilare la procedura o parti da zero.",
                            "aria_label": "Modelli di query disponibili",
                            "options": {
                                "custom": {
                                    "title": "Query vuota",
                                    "description": "Crea la query manualmente senza preset.",
                                },
                                "basic": {
                                    "title": "Campi essenziali",
                                    "description": "Include identificativi e campi di audit per esportazioni rapide.",
                                },
                                "recent": {
                                    "title": "Modifiche recenti",
                                    "description": "Mostra i record aggiornati di recente ordinati per LastModifiedDate.",
                                },
                                "child_summary": {
                                    "title": "Con record figli",
                                    "description": "Parte da una sottoquery che recupera i record correlati.",
                                },
                            },
                        },
                        "object": {
                            "label": "Oggetti",
                            "title": "Scegli l'oggetto principale",
                            "description": "Scegli l'oggetto radice e configura eventuali relazioni figlie.",
                            "child_title": "Relazioni figlie (sottoquery)",
                            "add_child": "Aggiungi relazione figlia",
                            "child_empty": "Nessuna relazione figlia aggiunta.",
                            "labels": {
                                "object": "Oggetto di base",
                                "alias": "Alias (opzionale)",
                                "relationship": "Nome API della relazione",
                                "fields": "Campi figli",
                                "where": "Filtro figli",
                            },
                            "placeholders": {
                        ...
                        "fields": {
                            "label": "Campi",
                            "title": "Seleziona i campi",
                            "description": "Cerca e scegli i campi da includere nella clausola SELECT.",
                            "labels": {
                                "search": "Cerca campi",
                                "custom_field": "Aggiungi campo relazionato o formula",
                            },
                            "placeholders": {
                                "search": "Filtra i campi per nome",
                                "custom_field": "es. Owner.Name o FORMAT(CreatedDate)",
                            },
                            "add_custom": "Aggiungi campo",
                            "selected_title": "Campi selezionati",
                            "selected_empty": "Nessun campo selezionato.",
                            "empty": "Seleziona un oggetto per caricare i campi.",
                        },
                        "filters": {
                            "label": "Filtri",
                            "title": "Affina i risultati",
                            "description": "Aggiungi clausole WHERE, ordinamento e limiti per completare la query.",
                            "conditions_title": "Condizioni",
                            "add_condition": "Aggiungi condizione",
                            "conditions_empty": "Nessuna condizione definita.",
                            "order_title": "Ordinamento e limite",
                            "add_order": "Aggiungi campo di ordinamento",
                            "order_empty": "Nessun campo ORDER BY aggiunto.",
                            "labels": {
                                "field": "Campo",
                                "operator": "Operatore",
                                "value": "Valore",
                            ...
                            "directions": {"asc": "Crescente", "desc": "Decrescente"},
                            "placeholders": {
                                "field": "Nome API del campo",
                                "operator": "Scegli",
                                "value": "Valore o elenco separato da virgole",
                                "limit": "100",
                            },
                        },
                    },
        ...
        "frontend": {
            "toast": {
                ...
                "composer_requires_org": "Seleziona un'organizzazione prima di comporre una query",
                "composer_select_object": "Scegli un oggetto per continuare",
                "composer_select_field": "Scegli almeno un campo",
                "composer_child_invalid": "Aggiungi il nome della relazione e almeno un campo",
                "composer_condition_invalid": "Completa la condizione prima di aggiungerla",
                "composer_order_invalid": "Seleziona un campo per l'ordinamento",
                "composer_inserted": "Query inserita nell'editor",
            },
            "query": {
