    ...
    "en": {
        ...
        "account_explorer": {
            ...
            "results": {
                ...
                "alerts_heading": "Triggered alerts",
            ...
            "alerts": {
                "badge_short": "{count} alert(s)",
                "unnamed": "Alert",
            },
            "setup": {
                "button": "Set up",
                "title": "Set up explorer",
                "description": "Customize the objects, fields, and alerts shown in the explorer.",
                ...
                "alerts_title": "Alerts",
                "alerts_help": "Highlight accounts and related records in red when their data matches custom business rules.",
                "alerts_guide_link": "View alert guide",
                "alerts_add_button": "Add alert",
                "alerts_empty": "No alerts configured yet. Add one to start monitoring your data quality checks.",
                "alerts_default_title": "Alert {index}",
                "alerts_remove_button": "Remove alert",
                "alerts_label": "Alert label",
                "alerts_object_label": "Evaluate object",
                "alerts_object_placeholder": "Select an object",
                "alerts_object_help": "Choose which object's records should trigger this alert. Account-level alerts run once per account.",
                "alerts_description_label": "Description (optional)",
                "alerts_condition_label": "Condition",
                "alerts_condition_help": "Write a condition using operators like ==, !=, &&, || and helpers such as is_blank(). Use record.Field for the current record, account.Field for the parent account, and related.ObjectName to inspect linked records.",
                "alerts_field_label": "Quick insert field",
                "alerts_field_placeholder": "Field API name",
                "alerts_insert_button": "Insert",
                "alerts_insert_help": "Select a field to append to the condition. Autocomplete is available when an org is selected.",
        ...
        "guide": {
            ...
            "sections": {
                ...
                "account_explorer_alerts": {
                    "title": "4. Configure Account Explorer alerts",
                    "intro": "Use alerts to surface data quality issues such as duplicate contacts, missing roles, or mismatched SOL emails directly inside the explorer.",
                    "steps": [
                        "Open Account Explorer, click <strong>Set up</strong>, and scroll to the <strong>Alerts</strong> section.",
                        "Add an alert, choose the object to evaluate (Account, Contact, ContactPointEmail, etc.), and provide a clear label and optional description so teammates know why it triggers.",
                        "Compose the condition with expressions like <code>record.Roles == 'SOL'</code>, operators such as <code>==</code>, <code>!=</code>, <code>&amp;&amp;</code>, <code>||</code>, and helper functions including <code>is_blank()</code>, <code>equals_ignore_case()</code>, <code>has_duplicates()</code>, <code>any()</code>, or <code>all()</code>. Combine checks to cover cases like contacts without roles, duplicated names or tax codes, missing phone/email channels, or SOL referents lacking the correct SOL email type.",
                    ],
                    "examples_title": "Example alert expressions",
                    "examples": [
                        "<code>is_blank(record.Roles)</code> — highlight contacts without any assigned role.",
                        "<code>is_blank(coalesce(record.Phone, record.MobilePhone, record.Email))</code> — find contacts that do not have at least one phone or email.",
                        "<code>has_duplicates(values(related.Contact, 'Email'), case_insensitive=True)</code> — flag accounts with contacts sharing the same email address (ignoring case).",
                        "<code>record.Email and not any(equals_ignore_case(point.EmailAddress, record.Email) for point in related.ContactPointEmail)</code> — require a matching ContactPointEmail entry for every contact email.",
                        "<code>equals_ignore_case(record.Roles, 'SOL') and not any(equals_ignore_case(point.UsageType, 'SOL') for point in related.ContactPointEmail)</code> — catch SOL referents whose email usage type is not set to SOL.",
                    ],
                },
                "query": {
                    "title": "5. Run SOQL queries",
                    "steps": [
                ...
                "advanced": {
                    "title": "6. Handle large result sets",
                    "steps": [
        ...
        "frontend": {
            ...
            "account_explorer": {
                ...
                "alerts": {
                    "fields_failed": "Unable to load fields for this object.",
                    "no_object": "Select an object before inserting a field.",
                    "no_field": "Choose a field to insert into the condition.",
                },
                "run": {
                    "org_placeholder": "Select an org",
                    "generated_at": "Data generated {timestamp}",
    ...
    "it": {
        ...
        "account_explorer": {
            ...
            "results": {
                ...
                "alerts_heading": "Avvisi attivati",
            ...
            "alerts": {
                "badge_short": "{count} avvisi",
                "unnamed": "Avviso",
            },
            "setup": {
                "button": "Configura",
                "title": "Configura esploratore",
                "description": "Personalizza gli oggetti, i campi e gli avvisi mostrati nell'esploratore.",
                ...
                "alerts_title": "Avvisi",
                "alerts_help": "Evidenzia in rosso account e record collegati quando rispettano regole di business personalizzate.",
                "alerts_guide_link": "Apri la guida agli avvisi",
                "alerts_add_button": "Aggiungi avviso",
                "alerts_empty": "Nessun avviso configurato. Aggiungine uno per iniziare a monitorare la qualità dei dati.",
                "alerts_default_title": "Avviso {index}",
                "alerts_remove_button": "Rimuovi avviso",
                "alerts_label": "Etichetta avviso",
                "alerts_object_label": "Oggetto da valutare",
                "alerts_object_placeholder": "Seleziona un oggetto",
                "alerts_object_help": "Scegli quale oggetto deve attivare l'avviso. Gli avvisi sull'Account vengono valutati una sola volta per account.",
                "alerts_description_label": "Descrizione (opzionale)",
                "alerts_condition_label": "Condizione",
                "alerts_condition_help": "Scrivi una condizione usando operatori come ==, !=, &&, || e funzioni di supporto come is_blank(). Usa record.Campo per il record corrente, account.Campo per l'account e related.NomeOggetto per consultare i record collegati.",
                "alerts_field_label": "Inserimento rapido campo",
                "alerts_field_placeholder": "Nome API del campo",
                "alerts_insert_button": "Inserisci",
                "alerts_insert_help": "Seleziona un campo da aggiungere alla condizione. L'autocompletamento è disponibile quando scegli un'organizzazione.",
        ...
        "guide": {
            ...
            "sections": {
                ...
                "account_explorer_alerts": {
                    "title": "4. Configura gli avvisi dell'Account Explorer",
                    "intro": "Gli avvisi ti aiutano a mettere in evidenza problemi di qualità dei dati — contatti duplicati, ruoli mancanti, recapiti assenti o incoerenze sulle email SOL — direttamente nell'esploratore.",
                    "steps": [
                        "Apri Account Explorer, fai clic su <strong>Configura</strong> e scorri fino alla sezione <strong>Avvisi</strong>.",
                        "Aggiungi un avviso, scegli l'oggetto da valutare (Account, Contact, ContactPointEmail, ecc.) e compila un'etichetta chiara con una descrizione opzionale per spiegare quando si attiva.",
                        "Scrivi la condizione usando espressioni con operatori (<code>==</code>, <code>!=</code>, <code>&amp;&amp;</code>, <code>||</code>) e funzioni come <code>is_blank()</code>, <code>equals_ignore_case()</code>, <code>has_duplicates()</code>, <code>any()</code> o <code>all()</code>. Combina i controlli per individuare contatti duplicati con lo stesso ruolo, contatti senza ruoli o recapiti, ContactPoint mancanti o referenti SOL senza email di tipo SOL.",
                    ],
                    "examples_title": "Esempi di espressioni",
                    "examples": [
                        "<code>is_blank(record.Roles)</code> — evidenzia i contatti senza ruoli.",
                        "<code>is_blank(coalesce(record.Phone, record.MobilePhone, record.Email))</code> — individua contatti senza almeno un telefono o un'email.",
                        "<code>has_duplicates(values(related.Contact, 'Email'), case_insensitive=True)</code> — segnala account con contatti che condividono la stessa email (ignorando maiuscole/minuscole).",
                        "<code>record.Email and not any(equals_ignore_case(point.EmailAddress, record.Email) for point in related.ContactPointEmail)</code> — richiede un ContactPointEmail per ogni email del contatto.",
                        "<code>equals_ignore_case(record.Roles, 'SOL') and not any(equals_ignore_case(point.UsageType, 'SOL') for point in related.ContactPointEmail)</code> — individua referenti SOL senza email di tipo SOL.",
                    ],
                },
                "query": {
                    "title": "5. Esegui query SOQL",
                    "steps": [
                ...
                "advanced": {
                    "title": "6. Gestisci risultati di grandi dimensioni",
                    "steps": [
        ...
        "frontend": {
            ...
            "account_explorer": {
                ...
                "alerts": {
                    "fields_failed": "Impossibile caricare i campi per questo oggetto.",
                    "no_object": "Seleziona un oggetto prima di inserire un campo.",
                    "no_field": "Scegli un campo da inserire nella condizione.",
                },
                "run": {
                    "org_placeholder": "Seleziona un'organizzazione",
                    "generated_at": "Dati generati {timestamp}",
